...
//  Maps Direction
//
//  Created by Ruan DE BEER on 2019/10/23.
//  Copyright © 2019 Ruan DE BEER. All rights reserved.
//
...
//		self.googleMaps?.animate(to: camera)
	...
	//MARK: - this is the function for creating direction path, from start location to desination location
	...
	// MARK: when starting location tap, this will open the search location
